...
typedef grub_efi_mac_address_t grub_efi_pxe_mac_address_t;
typedef grub_efi_ipv4_address_t grub_efi_pxe_ipv4_address_t;
typedef grub_efi_ipv6_address_t grub_efi_pxe_ipv6_address_t;
...
typedef grub_efi_ip_address_t grub_efi_pxe_ip_address_t;
